...
<br>
<br>
*If you do NOT want a user/users on your server to have access to chat room messages, please modify the permissions of the user(s) and/or the `/etc/fri/room` directory. For example, you can use `chmod 600 /etc/fri/room` to remove read permissions of non-superusers for all chat rooms.
